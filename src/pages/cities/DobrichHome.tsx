...
/**
 * DobrichHome — main page for /bg/dobrich/
 *
 * SEO targets:
...
const DobrichHome = () => {
  ...
  const canonical = `${BASE_URL}/bg/dobrich/`;
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 py-12 md:py-20 relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-primary-foreground/90 mb-6 md:mb-8 max-w-2xl [text-shadow:_0_2px_8px_rgba(0,0,0,0.6)]">
              Професионален ремонт на покриви, хидроизолация и нови покриви в Добрич. Безплатен оглед в рамките на 24 часа.
            </p>
            ...
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
                <Button asChild size="lg" className="w-full sm:w-auto h-12 md:h-16 bg-accent hover:bg-accent/90 text-accent-foreground text-base md:text-lg font-bold px-5 md:px-8 shadow-lg whitespace-nowrap">
                  <Link to="/bg/bezplaten-ogled">Безплатен оглед в Добрич</Link>
                </Button>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Обслужваме всички квартали в Добрич
            </h2>
      ...
      <CTASection
        title="Поискайте безплатен оглед в Добрич"
