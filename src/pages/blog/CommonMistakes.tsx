...
const CommonMistakes = () => {
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      { "@type": "Question", "name": "Колко струва ремонт на покрив във Варна?", "acceptedAnswer": { "@type": "Answer", "text": "Средни цени за 2026: частичен ремонт 150-800 EUR, подмяна на керемиди 20-35 EUR/м², хидроизолация 8-25 EUR/м², пълна подмяна на покрив 25-50 EUR/м². Безплатен оглед и точна оферта — обадете се на 089 397 1873." } }
    ]
  };
