  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="Защо тече покривът? 8 най-чести причини за течове от покрива и цени за ремонт. Спешна реакция до 24ч. Безплатен оглед. ☎ 089 397 1873 Варна." />
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-8 flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-red-700">Не чакайте — всеки ден забавяне увеличава щетите. Обадете се на <a href="tel:0893971873" className="font-bold underline">089 397 1873</a> за спешна реакция до 24 часа. Безплатен оглед.</p>
                </div>
              </div>
              ...
              <section className="mb-12">
                ...
                <div className="space-y-4 mb-6">
                  {[
                    ...
                    { step: "4", title: "Обадете се на професионалист", desc: "Обадете се на 089 397 1873 за спешна реакция до 24 часа. Не се опитвайте да се качвате на покрива сами, особено при мокра или ветровита погода." },
