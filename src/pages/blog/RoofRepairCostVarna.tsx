              ...
              <section className="mb-12">
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
                  <p className="text-green-800 font-medium">
                    💡 <strong>Важно:</strong> Цените са ориентировъчни и могат да варират в зависимост от конкретния обект. За точна оферта е необходим безплатен оглед на място. Обадете се на <a href="tel:0893971873" className="underline font-bold">089 397 1873</a> за уговаряне.
                  </p>
                </div>
              </section>
