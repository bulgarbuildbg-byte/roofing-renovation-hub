  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        ...
        <meta name="description" content="Безплатен онлайн калкулатор за ремонт, хидроизолация и нов покрив във Варна. Получете ориентировъчна цена в евро за 60 секунди. ☎ 089 397 1873" />
