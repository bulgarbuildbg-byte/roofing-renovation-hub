  ...
  const faqs = [
    {
      ...
      answer: "Цената за ремонт на покрив зависи от много фактори: вида на покрива, площта, състоянието и необходимите материали. Цените започват от 15-20 лв/кв.м за прост ремонт и могат да достигнат 80-100 лв/кв.м за цялостна подмяна. Препоръчваме безплатен оглед за точна оценка."
    },
    {
