  ...
  const faqs = [
    {
      ...
      answer: "Препоръчваме минимум два пълни прегледа годишно — един напролет след зимния сезон и един наесен преди началото на дъждовния период. Пролетната проверка е особено важна, тъй като зимните условия — сняг, лед и температурни промени — могат да причинят скрити повреди по керемидите, хидроизолацията и обшивките. Почистването на улуците следва да се извършва поне два пъти годишно, а при наличие на дървета в близост — по-често. При по-стари покриви (над 20 години) или след тежки бурни явления препоръчваме допълнителни проверки. Редовната поддръжка е инвестиция, която спестява многократно повече в сравнение с евентуалния аварийни ремонт."
    },
    {
      question: "Колко струва поддръжката на покрива?",
      answer: "Цените зависят от вида и обема на работата. Базовият визуален преглед с доклад за състоянието Started от 30 €. Почистването на улуци е от 3 €/м. Пълното почистване на покривната повърхност от мъх и лишеи — от 3–4 €/кв.м. Годишният пакет за поддръжка, включващ два прегледа, почистване на улуци и дребни ремонти, е достъпен от 128 €/год. При по-голяма жилищна сграда или търговски обект цените се договарят индивидуално. Всички цени включват доклад за извършените дейности и препоръки за следващи стъпки."
    },
    {
      question: "Мога ли сам да почистя покрива си?",
      answer: "Технически е възможно, но не е препоръчително. Работата на покрив крие сериозни рискове от падане, особено при мокри или замърсени повърхности. Освен безопасността, некоректното почистване може да причини повреди — счупени керемиди, нарушена хидроизолация или изкривени улуци. Профосионалните екипи разполагат с лично предпазно оборудване, подходящи инструменти и опит да забележат потенциални проблеми по покрива по времето на почистването. При нашите почиствания правим едновременно и профилактичен преглед, което е добавена стойност."
    },
    {
      question: "Какво включва годишният пакет за поддръжка?",
      answer: "Годишният пакет за поддръжка включва: два пълни прегледа на покрива (пролет и есен) с писмен доклад и снимки, почистване на улуци и водосточни тръби два пъти годишно, дребни ремонти на място до 2 часа включено (подмяна на единични керемиди, заздравяване на уплътнения) и приоритетно обслужване при аварии — извън опашката. Пакетът е особено подходящ за собственици на по-стари покриви или за наемодатели, които искат редовна грижа без излишни притеснения. Сключваме годишен договор и ви уведомяваме при наближаване на срока."
    },
    {
      question: "Как да разбера, че покривът ми има нужда от поддръжка?",
      answer: "Признаци, че е дошло времето за поддръжка: запушени или провиснали улуци и водостоци; видим зелен или черен мъх по керемидите; счупени, изместени или липсващи керемиди; ръжда по ламаринените елементи, обшивки или улуци; петна от влага по тавана или стените; миризма на мухъл в таванско помещение; и необяснимо увеличени сметки за отопление — което може да е знак за намокрена топлоизолация. При наличие на поне един от тези признаци обадете се за безплатна консултация."
    },
    {
      question: "Почиствате ли сняг от покриви?",
      answer: "Да, предлагаме услуга за снегопочистване при необходимост. Натрупването на сняг над 30–40 см или образуването на ледени висулки и язове може да натовари покривната конструкция над допустимите граници и да причини теч или дори конструктивна повреда. Снегопочистването е особено важно при по-стари сгради, покриви с малък наклон и при прогноза за продължителни снеговалежи. Извършваме услугата безопасно с подходящо оборудване. Обадете се при нужда и ще реагираме бързо."
    },
    {
      question: "Работите ли в цяла Варна и областта?",
      answer: "Да, предлагаме услуги по поддръжка на покриви в целия град Варна и в населените места на Област Варна. Обслужваме редовни клиенти в Аксаково, Белослав, Девня, Суворово, Долни чифлик, Бяла, Провадия и курортните комплекси Златни пясъци, Св. Константин и Камчия. При редовни годишни договори за сгради извън Варна транспортните разходи са включени или сведени до минимум. Свържете се с нас за индивидуална оферта за поддръжка на покрива."
    },
    {
      question: "Може ли поддръжката да продължи живота на покрива?",
      answer: "Категорично да. Редовната поддръжка е доказано най-ефективният начин за удължаване живота на покрива с 30–50%. Мъхът и лишеите, ако не се отстраняват, задържат постоянна влага върху керемидите и ги разрушават ускорено. Запушените улуци принуждават водата да прелива назад под покритието. Незабелязаните дребни повреди прерастват в скъпи аварии. Покривите с редовна поддръжка издържат с 10–15 години по-дълго от пренебрегваните — разликата е именно в навременната намеса."
    }
  ];
