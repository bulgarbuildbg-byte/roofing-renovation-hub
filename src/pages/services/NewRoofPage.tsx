...
const NewRoofPage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "За керемиден покрив на къща с покрив 100 кв.м бюджетът е приблизително 9000-12000 лв (конструкция, изолация, покритие, водосточна система). За метален покрив е около 5000-7000 лв. Точната цена се определя след оглед и проектиране."
    }
  ];
