...
const FlatRoofPage = () => {
  ...
  const schemaData = { "@context": "https://schema.org", "@type": "Service", "name": "Ремонт на плоски покриви Варна", "provider": { "@type": "RoofingContractor", "name": "RemontNaPokriviVarna", "telephone": "+359893971873", "email": "remontnapokrivivarna@gmail.com", "address": { "@type": "PostalAddress", "streetAddress": "ул. Уста Колю Фичето 25 А", "addressLocality": "Варна", "addressCountry": "BG" } }, "areaServed": [{ "@type": "City", "name": "Варна" }], "description": "Професионален ремонт и хидроизолация на плоски покриви във Варна.", "offers": { "@type": "AggregateOffer", "lowPrice": "11", "highPrice": "26", "priceCurrency": "EUR", "offerCount": "6" } };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://www.remontnapokrivivarna.bg/bg/remont-na-ploski-pokrivi" />
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="max-w-4xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                <Button asChild size="lg" className="bg-primary/40 backdrop-blur-sm border-2 border-white/80 text-white hover:bg-white/20"><a href="tel:0893971873"><Phone className="w-5 h-5 mr-2" />Обади се сега</a></Button>
              </div>
