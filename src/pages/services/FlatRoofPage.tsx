...
const FlatRoofPage = () => {
  ...
  const schemaData = { "@context": "https://schema.org", "@type": "Service", "name": "Ремонт на плоски покриви Варна", "provider": { "@type": "RoofingContractor", "name": "RemontNaPokriviVarna", "telephone": "+359884997659", "email": "remontnapokrivivarna@gmail.com", "address": { "@type": "PostalAddress", "streetAddress": "ул. Уста Колю Фичето 25 А", "addressLocality": "Варна", "addressCountry": "BG" } }, "areaServed": [{ "@type": "City", "name": "Варна" }], "description": "Професионален ремонт и хидроизолация на плоски покриви във Варна.", "offers": { "@type": "AggregateOffer", "lowPrice": "11", "highPrice": "26", "priceCurrency": "EUR", "offerCount": "6" } };
