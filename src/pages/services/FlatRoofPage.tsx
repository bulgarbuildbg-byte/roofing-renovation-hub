...
const FlatRoofPage = () => {
  ...
  const priceRanges = [
    { service: "Ремонт на локален теч", price: "от 80 лв", note: "Диагностика и кръпка" },
    { service: "Битумна хидроизолация (еднослойна)", price: "от 22 лв/кв.м", note: "Материал и труд" },
    { service: "Битумна хидроизолация (двуслойна)", price: "от 28 лв/кв.м", note: "Препоръчително" },
    { service: "PVC/TPO мембрана", price: "от 45 лв/кв.м", note: "С топлоизолация" },
    { service: "Течна хидроизолация", price: "от 35 лв/кв.м", note: "Идеална за детайли" },
    { service: "Топлоизолация на покрив", price: "от 18 лв/кв.м", note: "XPS или минерална вата" }
  ];
