...
const MetalRoofPage = () => {
  ...
  const schemaData = { "@context": "https://schema.org", "@type": "Service", "name": "Метални покриви Варна", "provider": { "@type": "RoofingContractor", "name": "RemontNaPokriviVarna", "telephone": "+359884997659", "email": "office@bulgarbuild.com", "address": { "@type": "PostalAddress", "streetAddress": "ул. Уста Колю Фичето 25 А", "addressLocality": "Варна", "addressCountry": "BG" } }, "areaServed": [{ "@type": "City", "name": "Варна" }], "description": "Професионален монтаж и ремонт на метални покриви във Варна. Гаранция до 50 години.", "offers": { "@type": "AggregateOffer", "lowPrice": "6", "highPrice": "18", "priceCurrency": "EUR", "offerCount": "6" } };
