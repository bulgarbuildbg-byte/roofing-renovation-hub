...
const MetalRoofPage = () => {
  ...
  const priceRanges = [
    { service: "Метални керемиди (монтаж)", price: "от 18 лв/кв.м", note: "Без материал" },
    { service: "Трапецовидна ламарина", price: "от 12 лв/кв.м", note: "Без материал" },
    { service: "Стоящ фалц", price: "от 35 лв/кв.м", note: "Без материал" },
    { service: "Сандвич панели", price: "от 28 лв/кв.м", note: "Без материал" },
    { service: "Ремонт/боядисване", price: "от 8 лв/кв.м", note: "Почистване + боя" },
    { service: "Водосточна система", price: "от 18 лв/м", note: "Улук + тръба + монтаж" }
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "За метални керемиди с качествено покритие, включително материали, монтаж и водосточна система, бюджетът е приблизително 4500-6500 лв. За трапецовидна ламарина е 3000-4000 лв. Точната цена се определя след оглед."
    },
    {
