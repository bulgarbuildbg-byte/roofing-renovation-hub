...
const TileReplacementPage = () => {
  ...
  const priceRanges = [
    { service: "Подмяна на единична керемида", price: "от 8 лв/бр", note: "Включва материал и труд" },
    { service: "Частична подмяна (до 20 кв.м)", price: "от 25 лв/кв.м", note: "Материали + монтаж" },
    { service: "Пълна подмяна на керемиди", price: "от 35 лв/кв.м", note: "Демонтаж, материали, монтаж" },
    { service: "Подмяна с нови летви", price: "от 45 лв/кв.м", note: "Включва летви и мембрана" },
    { service: "Ремонт на било и ръбове", price: "от 15 лв/м", note: "Капаци и уплътнение" },
    { service: "Монтаж на снегозадържатели", price: "от 25 лв/м", note: "Материал и монтаж" }
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "При пълна подмяна с качествени бетонни керемиди бюджетът е приблизително 3500-4500 лв (материали и труд). При керамични керемиди е 5000-7000 лв. Цената зависи от сложността на покрива и избраните материали."
    },
    {
