...
const TileReplacementPage = () => {
  ...
  const schemaData = { "@context": "https://schema.org", "@type": "Service", "name": "Ремонт на керемидени покриви Варна", "provider": { "@type": "RoofingContractor", "name": "RemontNaPokriviVarna", "telephone": "+359884997659", "email": "office@bulgarbuild.com", "address": { "@type": "PostalAddress", "streetAddress": "ул. Уста Колю Фичето 25 А", "addressLocality": "Варна", "addressCountry": "BG" } }, "areaServed": [{ "@type": "City", "name": "Варна" }, { "@type": "Place", "name": "Аксаково" }, { "@type": "Place", "name": "Златни пясъци" }], "description": "Професионален ремонт на керемидени покриви във Варна - бетонни, керамични, марсилски. Частична или пълна подмяна с 15 години гаранция.", "offers": { "@type": "AggregateOffer", "lowPrice": "4", "highPrice": "23", "priceCurrency": "EUR", "offerCount": "6" } };
