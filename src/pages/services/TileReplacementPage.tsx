...
const TileReplacementPage = () => {
  ...
  const benefits = [
    ...
    { icon: Shield, title: "Гаранция до 5 години", description: "Предоставяме писмена гаранция за монтажа." },
  ...
  const schemaData = { "@context": "https://schema.org", "@type": "Service", "name": "Смяна на керемиди Варна", "provider": { "@type": "RoofingContractor", "name": "RemontNaPokriviVarna", "telephone": "+359884997659", "email": "remontnapokrivivarna@abv.bg", "address": { "@type": "PostalAddress", "streetAddress": "ул. Уста Колю Фичето 25 А", "addressLocality": "Варна", "addressCountry": "BG" } }, "areaServed": [{ "@type": "City", "name": "Варна" }, { "@type": "Place", "name": "Аксаково" }, { "@type": "Place", "name": "Златни пясъци" }], "description": "Професионална смяна на керемиди във Варна - бетонни, керамични, марсилски. Частична или пълна подмяна с гаранция до 5 години.", "offers": { "@type": "AggregateOffer", "lowPrice": "4", "highPrice": "23", "priceCurrency": "EUR", "offerCount": "6" } };
      ...
      <main className="pt-20">
        ...
        <section className="relative bg-primary text-primary-foreground py-16 md:py-24 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="max-w-4xl">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Смяна на Керемиди Варна</h1>
              <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl">Професионална подмяна на счупени, стари или повредени керемиди. Работим с всички видове — бетонни, керамични, марсилски.</p>
              ...
              <div className="flex flex-wrap gap-4 text-sm">
                {["Безплатен оглед", "Работа по договор", "Гаранция за изпълнение", "Реални снимки от обекти"].map((item) => (
                  <div key={item} className="flex items-center gap-2 bg-primary-foreground/10 px-3 py-1.5 rounded-full">
                    <CheckCircle className="w-4 h-4 text-accent" /><span className="text-primary-foreground/90">{item}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4">
            ...
            <p className="text-muted-foreground text-center mb-12 max-w-2xl mx-auto">Прозрачен процес от първия контакт до завършения монтаж</p>
