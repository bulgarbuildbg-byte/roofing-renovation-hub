...
const RoofRepairPage = () => {
  ...
  const faqs = [
    {
      ...
      answer: "Цената за ремонт на покрив зависи от вида на повредата, използваните материали и сложността на работата. При частичен ремонт — подмяна на счупени керемиди или локализиран теч — цените започват от 40–80 €. При по-обширен ремонт на покривно покритие цените варират между 13 и 28 €/кв.м труд и материали. Цялостният ремонт на стар покрив с подмяна на хидроизолация и керемиди може да достигне 35–45 €/кв.м. Важно е да знаете, че всяка оферта, която предоставяме, е безплатна и не е обвързваща. Препоръчваме да не се доверявате на прекалено ниски оферти — качественият ремонт изисква правилни материали и опит. Нашите цени са прозрачни, без скрити такси, и се записват в договор."
    },
    {
      question: "Колко време отнема ремонтът на покрив?",
      answer: "Продължителността зависи от обема и вида на работата. Малък ремонт — подмяна на няколко счупени керемиди или заздравяване на теч около комин — може да се извърши за 2–4 часа. Частичен ремонт на 20–30 кв.м покривна площ обикновено отнема 1–2 работни дни. Цялостен ремонт на покрив от 100–150 кв.м — с демонтаж, нова хидроизолация и керемиди — изисква между 5 и 10 работни дни. Времето може да варира в зависимост от атмосферните условия, достъпността на покрива и необходимостта от скеле. Ние предоставяме реалистичен график предварително и се стремим да го спазваме."
    },
    {
      question: "Работите ли при спешни случаи и аварии?",
      answer: "Да, предлагаме аварийно обслужване при спешни течове и покривни щети. При обаждане за авария се стремим да реагираме в рамките на 2–4 часа за Варна и близките квартали. В случаи на активен теч при дъжд можем да поставим временна водозащитна мярка веднага, а трайният ремонт се извършва при подходящи метеорологични условия. Препоръчваме незабавно да позвъните при: активен теч, паднали керемиди след буря, видимо повредена покривна конструкция или щети след градушка. Бързата реакция ограничава вторичните щети по дървената конструкция, изолацията и интериора."
    },
    {
      question: "Каква гаранция получавам за ремонта?",
      answer: "Предоставяме писмена гаранция за всички извършени ремонтни работи. Стандартната ни гаранция е 5 години за ремонт на покривно покритие и до 10 години при пълна подмяна с хидроизолация. Гаранцията е описана подробно в договора, който подписваме преди започване на работата. Тя покрива дефекти, свързани с качеството на изпълнение и вложените материали при нормални климатични условия. В гаранционния период, ако се появи проблем, свързан с нашата работа, отстраняваме го безплатно и в кратък срок. Допълнително, производителите на материалите като Bramac, Tondach и Sika предоставят собствена продуктова гаранция."
    },
    {
      question: "Предлагате ли безплатен оглед?",
      answer: "Да, първоначалният оглед е напълно безплатен за клиенти от Варна и региона. Нашият специалист посещава обекта, прави визуална инспекция на покрива отвън и при достъп — и от вътрешната страна. Правим снимки на проблемните зони и изготвяме доклад за състоянието на покрива. На база огледа ви предоставяме подробна оферта с описание на необходимите работи, материали и цена. Офертата е напълно необвързваща за вас. Обадете се на 088 499 7659 или попълнете формата за контакт и ще се свържем с вас в рамките на 24 часа за насрочване на оглед."
    },
    {
      question: "Работите ли през зимата?",
      answer: "Да, извършваме аварийни ремонти целогодишно — включително при зимни условия. При планови ремонти, включващи полагане на хидроизолационни материали, препоръчваме работа при температури над 5°C, тъй като при по-ниски температури битумните материали не залягат правилно. Монтажът на керемиди, ламарина и дървена конструкция може да се извършва и при по-ниски температури, стига да няма активни валежи или леден покрив. При зимни аварии (например буря, паднали клони, скъсана мембрана) поставяме незабавна временна защита и организираме трайния ремонт при подходящо метеорологично време."
    },
    {
      question: "Издавате ли договор и фактура?",
      answer: "Абсолютно. Работим само на официален договор и издаваме данъчна фактура за всички извършени услуги. В договора са описани подробно видовете работи, срокове за изпълнение, използвани материали и тяхното качество, крайна цена и гаранционни условия. Това е вашата правна защита и гаранция, че работите с легитимна компания, регистрирана по ЗДДС и с лицензиран строителен екип. Фактурата и договорът са задължителни документи за упражняване на гаранционните права."
    },
    {
      question: "Работите ли в цяла Варна и областта?",
      answer: "Да, обслужваме цял Варна и всички околни общини. Редовно извършваме ремонти в кварталите Бриз, Чайка, Левски, Аспарухово, Владиславово, Младост, Галата и Виница. Покриваме и населените места в Област Варна — Аксаково, Белослав, Девня, Провадия, Долни чифлик, Бяла, Суворово, Аврен, курортните комплекси Златни пясъци и Св. Константин. Разполагаме със собствен транспорт и осигуряваме логистика на материалите до всеки обект. За по-отдалечени места в Североизточна България се уточняват минимални транспортни разходи предварително."
    }
  ];
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Ремонт на покриви", "item": "https://www.remontnapokrivivarna.bg/ремонт-на-покриви" }
    ]
  };
