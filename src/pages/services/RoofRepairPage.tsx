...
const RoofRepairPage = () => {
  ...
  const priceRanges = [
    { service: "Ремонт на течове", price: "от 80 лв" },
    { service: "Подмяна на керемиди", price: "от 8 лв/бр" },
    { service: "Ремонт на комин", price: "от 200 лв" },
    { service: "Частичен ремонт на покрив", price: "от 25 лв/кв.м" },
    { service: "Цялостен ремонт", price: "от 55 лв/кв.м" },
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Цената зависи от причината за течаи обема на повредата. Минималната цена за отстраняване на теч е 80 лв. След безплатен оглед ще ви дадем точна оферта."
    }
  ];
