...
const WaterproofingPage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "При битумна хидроизолация цената е около 2800-3500 лв за 100 кв.м (материал и труд). За PVC мембрана бюджетът е 4000-5000 лв. Цената зависи от състоянието на основата, достъпността и сложността на детайлите."
    }
  ];
