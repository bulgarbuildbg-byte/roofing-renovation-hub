  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Ремонт на покрив на вноски от 105 €/месец. Съдействаме за кредит от TBI Bank, BNP Paribas, ДСК. Безплатна консултация и сравнение на оферти. ☎ 089 397 1873" />
        ...
        <section className="py-16 md:py-20 bg-background">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto prose prose-lg prose-slate">
              ...
              <ol>
                <li><strong>Свържете се с нас</strong> — по телефон (089 397 1873), имейл или онлайн формуляр</li>
