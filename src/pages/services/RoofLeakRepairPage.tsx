    ...
    <>
      ...
      <main className="pt-20">
        ...
        <section className="relative text-primary-foreground py-16 md:py-24 overflow-hidden">
          <img src={heroLeakRepair} alt="Ремонт на покривен теч – работник сменя керемиди" className="absolute inset-0 w-full h-full object-cover" />
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 [text-shadow:_0_3px_16px_rgba(0,0,0,0.9),_0_1px_4px_rgba(0,0,0,0.8)]">{t('pages.leakRepair.hero.title')}</h1>
              <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl [text-shadow:_0_2px_8px_rgba(0,0,0,0.6)]">{t('pages.leakRepair.hero.subtitle')}</p>
