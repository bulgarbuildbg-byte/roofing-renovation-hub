...
const RoofLeakRepairPage = () => {
  ...
  const priceRanges = [
    { service: "Локализиране и диагностика на теч", price: "от 50 лв", note: "Безплатно при последващ ремонт" },
    { service: "Ремонт на точков теч (керемида)", price: "от 80 лв", note: "Включва материали и труд" },
    { service: "Ремонт на теч около комин", price: "от 150 лв", note: "В зависимост от размера" },
    { service: "Подмяна на обшивка/примикване", price: "от 25 лв/м", note: "Материал и монтаж" },
    { service: "Ремонт на хидроизолация (кръпка)", price: "от 35 лв/кв.м", note: "При локални повреди" },
    { service: "Временна защита при аварии", price: "от 100 лв", note: "В зависимост от площта" }
  ];
