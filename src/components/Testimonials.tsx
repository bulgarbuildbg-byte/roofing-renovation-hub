...
const fallbackTestimonials: Testimonial[] = [
  ...
  { id: "3", text: "Професионална работа по хидроизолацията. Екипът беше точен, изряден и много вежлив. Ще ги препоръчам на приятели.", author_name: "Мария Колева", location: "кв. Аспарухово, Варна", rating: 5, avatar_url: "https://i.pravatar.cc/200?img=26", is_verified: true, service_type: "waterproofing" },
